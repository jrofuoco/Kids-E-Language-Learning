...
def levelTwelve(root, homePageCanvas, username, user, go_back_function):
    print(user)
    print("openlevelone")
    global stage
    stage = 1
    ...
    global image
    image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\lamp.png")
    ...
    levelText = customtkinter.CTkLabel(levelTenPage, text="Level: 12",
                                       font=("Comic Sans MS", 20),
                                       text_color="#fd6909")
    ...
    def twoNext():
        ...
        if stage == 2:
            ...
            nextImage = "lock.png"
            image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\" + nextImage)
            resized_image = image.resize((image.width // 5, image.height // 6))
    ...
    def playAppleVoice():
        print(stage)
        if stage == 1:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\lampvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 2:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\lampvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 3:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\lockvoice.wav")
            pygame.mixer.music.play(loops=0)
