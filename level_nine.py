...
def levelNine(root, homePageCanvas, username, user, go_back_function):
    print(user)
    print("openlevelone")
    global stage
    stage = 1
    ...
    levelNinePage = tk.Canvas(root, width=1080, height=720)
    levelNinePage.create_image(0, 0, anchor=tk.NW, image=background)
    levelNinePage.image = background
    levelNinePage.after(100, levelNinePage.pack)
    ...
    global image
    image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\icecream.png")
    resized_image1 = image.resize((image.width // 6, image.height // 6))
    imagetk = ImageTk.PhotoImage(resized_image1)

    banana = customtkinter.CTkLabel(levelNinePage,
                                        text="",
                                        fg_color="#ffffff",
                                        image=imagetk).place(relx=0.50, rely=0.30, anchor=customtkinter.CENTER)

    spellTheWord = customtkinter.CTkLabel(levelNinePage,
                                          text="Spell The Word",
                                          text_color="#fd6909",
                                          fg_color="#ffffff",
                                          font=("Comic Sans MS", 24)).place(relx=0.5, rely=0.67 , anchor=tk.CENTER)

    usernameText = customtkinter.CTkLabel(levelNinePage, text=username,
                                          font=("Comic Sans MS", 20),
                                          text_color="#fd6909")
    usernameText.place(relx=0.83, rely=0.01)

    levelText = customtkinter.CTkLabel(levelNinePage, text="Level: 9",
                                       font=("Comic Sans MS", 20),
                                       text_color="#fd6909")
    levelText.place(relx=0.90, rely=0.01)

    def twoNext():
        nextImage = "island.png"
        ...
        if stage == 2:
            airplaneImage = customtkinter.CTkLabel(levelNinePage,
                                                   text="",
                                                   fg_color="#ffffff",
            ...
            arrow = customtkinter.CTkLabel(levelNinePage,
                                           text="",
                                           fg_color="#ffffff",
    ...
    def playAppleVoice():
        print(stage)
        if stage == 1:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\icecreamvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 2:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\islandvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 3:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\icevoice.wav")
            pygame.mixer.music.play(loops=0)

    levelComplete = customtkinter.CTkLabel(levelNinePage,
                                           text="Level Complete",
                                           text_color="#fd6909",
                                           fg_color="#ffffff",
    ...
    def next():
        ...
        if answer == "icecream":
            ...
            stage = 2
            levelNinePage.after(100, twoNext)
        elif answer == "island":
            answerEntry.delete(0, tk.END)
            stage = 3
            levelNinePage.after(100, twoNext)
    ...
    wrongAnswer = customtkinter.CTkLabel(levelNinePage,
                                         text="Wrong Answer!",
                                         text_color="#ffffff",
                                       fg_color="#ffffff",
                                       font=("Comic Sans MS", 24))
    ...
    def count_down(count):
        ...
        if count > 0:
            ...
            levelNinePage.destroy()
            go_back_function()

    countDown = customtkinter.CTkLabel(levelNinePage,
                                       text="asd",
                                       text_color="#fd6909",
                                       fg_color="#ffffff",
                                       font=("Comic Sans MS", 24))
    #--------------------------------ENTRYBOXES------------------------------------
    answerEntry = customtkinter.CTkEntry(levelNinePage, placeholder_text="?",
                                           border_color="#b14802",
                                            font=("Comic Sans MS", 20),
                                           width=200, height=40,
                                           justify='center',
    ...
    # --------------------------------ENTER BUTTONS---------------------------------
    enterButton = customtkinter.CTkButton(levelNinePage, text="Enter",
                                         font=("Comic Sans MS", 20),
                                         text_color="white",
                                         corner_radius=10,
                                         hover_color="#b14802",
    ...
    #--------------------------------PLAY VOICES-----------------------------------
    playAppleVoiceButton = customtkinter.CTkButton(levelNinePage, text="Play",
                                         font=("Comic Sans MS", 20),
                                         text_color="white",
                                         image=speakerIcon,
                                         corner_radius=10,
    ...
    def backButton():
        ...
        go_back_function()
    backButton = customtkinter.CTkButton(levelNinePage, text="Back",
                                         font=("Comic Sans MS", 20),
                                         text_color="white",
                                         corner_radius=10,
                                         hover_color="#b14802",
