...
def levelThree(root, homePageCanvas, username, user, go_back_function):
    print(user)
    print("openlevelone")
    global stage
    stage = 1
    ...
    levelThreePage = tk.Canvas(root, width=1080, height=720)
    levelThreePage.create_image(0, 0, anchor=tk.NW, image=background)
    levelThreePage.image = background
    levelThreePage.after(100, levelThreePage.pack)
    ...
    global image
    image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\clock.png")
    resized_image1 = image.resize((image.width // 6, image.height // 6))
    imagetk = ImageTk.PhotoImage(resized_image1)

    banana = customtkinter.CTkLabel(levelThreePage,
                                        text="",
                                        fg_color="#ffffff",
                                        image=imagetk).place(relx=0.50, rely=0.30, anchor=customtkinter.CENTER)

    spellTheWord = customtkinter.CTkLabel(levelThreePage,
                                          text="Spell The Word",
                                          text_color="#fd6909",
                                          fg_color="#ffffff",
                                          font=("Comic Sans MS", 24)).place(relx=0.5, rely=0.67 , anchor=tk.CENTER)

    usernameText = customtkinter.CTkLabel(levelThreePage, text=username,
                                          font=("Comic Sans MS", 20),
                                          text_color="#fd6909")
    usernameText.place(relx=0.83, rely=0.01)

    levelText = customtkinter.CTkLabel(levelThreePage, text="Level: 3",
                                       font=("Comic Sans MS", 20),
                                       text_color="#fd6909")
    ...
    def twoNext():
        ...
        if stage == 2:
            airplaneImage = customtkinter.CTkLabel(levelThreePage,
                                                   text="",
                                                   fg_color="#ffffff",
            ...
            arrow = customtkinter.CTkLabel(levelThreePage,
                                           text="",
                                           fg_color="#ffffff",
                                           image=arrow).place(relx=0.50, rely=0.30, anchor=customtkinter.CENTER)

    def backButton():
        levelThreePage.destroy()
    ...
    def playAppleVoice():
        print(stage)
        if stage == 1:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\clockvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 2:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\catvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 3:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\cowvoice.wav")
            pygame.mixer.music.play(loops=0)

    levelComplete = customtkinter.CTkLabel(levelThreePage,
                                           text="Level Complete",
                                           text_color="#fd6909",
                                           fg_color="#ffffff",
    ...
    def next():
        ...
        if answer == "clock":
            ...
            stage = 2
            levelThreePage.after(100, twoNext)
        elif answer == "cat":
            answerEntry.delete(0, tk.END)
            stage = 3
            levelThreePage.after(100, twoNext)
    ...
    wrongAnswer = customtkinter.CTkLabel(levelThreePage,
                                         text="Wrong Answer!",
                                         text_color="#ffffff",
                                       fg_color="#ffffff",
                                       font=("Comic Sans MS", 24))
    ...
    countDown = customtkinter.CTkLabel(levelThreePage,
                                       text="asd",
                                       text_color="#fd6909",
                                       fg_color="#ffffff",
                                       font=("Comic Sans MS", 24))
    ...
    #--------------------------------ENTRYBOXES------------------------------------
    answerEntry = customtkinter.CTkEntry(levelThreePage, placeholder_text="?",
                                           border_color="#b14802",
                                            font=("Comic Sans MS", 20),
                                           width=200, height=40,
                                           justify='center',
    ...
    # --------------------------------ENTER BUTTONS---------------------------------
    enterButton = customtkinter.CTkButton(levelThreePage, text="Enter",
                                         font=("Comic Sans MS", 20),
                                         text_color="white",
                                         corner_radius=10,
                                         hover_color="#b14802",
    ...
    #--------------------------------PLAY VOICES-----------------------------------
    playAppleVoiceButton = customtkinter.CTkButton(levelThreePage, text="Play",
                                         font=("Comic Sans MS", 20),
                                         text_color="white",
                                         image=speakerIcon,
                                         corner_radius=10,
    ...
    def backButton():
        ...
        print("Back Button From Level 1")
        go_back_function()
    backButton = customtkinter.CTkButton(levelThreePage, text="Back",
                                         font=("Comic Sans MS", 20),
                                         text_color="white",
                                         corner_radius=10,
                                         hover_color="#b14802",
