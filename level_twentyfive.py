...
def levelTwentyFive(root, homePageCanvas, username, user, go_back_function):
    ...
    global image
    image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\yatch.png")
    ...
    levelText = customtkinter.CTkLabel(levelTenPage, text="Level: 25",
                                       font=("Comic Sans MS", 20),
                                       text_color="#fd6909")
    ...
    def playAppleVoice():
        print(stage)
        if stage == 1:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\yatchvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 2:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\yarnvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 3:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\yolkvoice.wav")
            pygame.mixer.music.play(loops=0)
