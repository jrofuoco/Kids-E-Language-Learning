...
def levelEleven(root, homePageCanvas, username, user, go_back_function):
    print(user)
    print("openlevelone")
    global stage
    stage = 1
    ...
    global image
    image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\key.png")
    ...
    levelText = customtkinter.CTkLabel(levelTenPage, text="Level: 10",
                                       font=("Comic Sans MS", 20),
                                       text_color="#fd6909")
    ...
    def twoNext():
        ...
        if stage == 2:
            ...
            arrow = customtkinter.CTkLabel(levelTenPage,
                                           text="",
                                           fg_color="#ffffff",
                                           image=arrow).place(relx=0.48, rely=0.31, anchor=customtkinter.CENTER)

    def playAppleVoice():
        print(stage)
        if stage == 1:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\keyvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 2:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\kitevoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 3:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\kangaroovoice.wav")
            pygame.mixer.music.play(loops=0)
