...
def levelTwenty(root, homePageCanvas, username, user, go_back_function):
    print(user)
    print("openlevelone")
    global stage
    stage = 1
    ...
    global image
    image = Image.open("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\turtle.png")
    ...
    levelText = customtkinter.CTkLabel(levelTenPage, text="Level: 20",
                                       font=("Comic Sans MS", 20),
                                       text_color="#fd6909")
    levelText.place(relx=0.90, rely=0.01)

    def twoNext():
        nextImage = "toolbox.png"
        ...
        if stage == 2:
            ...
            arrow = customtkinter.CTkLabel(levelTenPage,
                                           text="",
                                           fg_color="#ffffff",
                                           image=arrow).place(relx=0.50, rely=0.32, anchor=customtkinter.CENTER)

    def playAppleVoice():
        print(stage)
        if stage == 1:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\turtlevoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 2:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\toolboxvoice.wav")
            pygame.mixer.music.play(loops=0)
        elif stage == 3:
            pygame.mixer.music.load("C:\\Users\\Fuoco\\PycharmProjects\\pythonProject\\.venv\\drawables\\thumbvoice.wav")
            pygame.mixer.music.play(loops=0)
